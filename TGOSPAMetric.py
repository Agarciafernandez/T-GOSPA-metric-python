#This code is a python implementation of the trajectory GOSPA (T-GOSPA) metric between sets of trajectories.
# In particular, it corresponds to the linear programming (LP) implementation in
# Á. F. García-Fernández, A. S. Rahmathullah and L. Svensson, 
...
def LP_metric_Cluster(X,Y,DAB,nx,ny,nxny,nxny2,T,c,p,gamma):
    ''' 
...
def LPTrajMetric_Cluster(X,Y,c,p,gamma):
    '''
