...
from TGOSPAQMetric import LPTrajQMetric_Cluster
from matplotlib import pyplot as plt

#Examples that show how the trajectory GOSPA (T-GOSPA) quasi-metric works
...
p=1
gamma=1
rho=0.6; #rho must be between 0 and 1
...
# Overall T-GOSPA q-metric decomposed against time steps
...
plt.ylabel('LP T-GOSPA q-metric decomposition')
plt.xlabel('Time step')
plt.plot()
